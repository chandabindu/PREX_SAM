void Plot(){
  ...
  double energy = 1200; // Unit MeV
  TH1D* h_ekin_e = new TH1D("h_ekin_e","h_ekin_e",1000,0,energy);
  TH1D* h_ekin_pos = new TH1D("h_ekin_pos","h_ekin_pos",1000,0,energy);
  TH1D* h_ekin_gamma = new TH1D("h_ekin_gamma","h_ekin_gamma",1000,0,energy);
  TH1D* h_ekin_prim = new TH1D("h_ekin_prim","h_ekin_prim",1000,0,energy);
  TH1D* h_ekin_sec = new TH1D("h_ekin_sec","h_ekin_sec",1000,0,energy);
